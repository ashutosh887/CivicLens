...
export function Footer({ footer }: FooterProps) {
  const socialLinks = config.founder.social;

  return (
    <footer className="border-t border-border shrink-0">
      <div className="mx-auto flex max-w-4xl flex-col gap-4 sm:gap-5 px-4 py-6 sm:py-8 md:py-10 text-center text-xs text-muted-foreground md:px-6">
